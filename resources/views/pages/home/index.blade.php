        ...
        <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10">
            <div class="reveal-on-scroll">
                ...
                <div class="mt-6 grid grid-cols-3 gap-4">
                    <div class="text-center p-4 rounded-xl bg-white shadow-sm border border-gray-50">
                        <div class="text-2xl sm:text-3xl font-bold text-[#7A1F2B]">3+</div>
                        <div class="text-[10px] sm:text-xs text-gray-500 mt-1 font-medium">Tahun Pengalaman</div>
                    </div>
                    <div class="text-center p-4 rounded-xl bg-white shadow-sm border border-gray-50">
                        <div class="text-2xl sm:text-3xl font-bold text-[#7A1F2B]">500+</div>
                        <div class="text-[10px] sm:text-xs text-gray-500 mt-1 font-medium">Pelanggan</div>
                    </div>
                    <div class="text-center p-4 rounded-xl bg-white shadow-sm border border-gray-50">
                        <div class="text-2xl sm:text-3xl font-bold text-[#7A1F2B]">4.9</div>
                        <div class="text-[10px] sm:text-xs text-gray-500 mt-1 font-medium">Rating Bintang</div>
                    </div>
                </div>
            </div>
                ...
                <div class="mt-6 space-y-3">
                    <a href="https://wa.me/6289653090248" target="_blank"
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-500 mt-0.5">0896-5309-0248 · Chat langsung</div>
                        </div>
                    </a>
                    <a href="https://instagram.com/sadita.florist" target="_blank"
                        ...
                        <div class="w-12 h-12 rounded-full bg-[#E4405F]/10 flex items-center justify-center text-[#E4405F]">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-500 mt-0.5">@sadita.florist · @sadita.hantaran</div>
                        </div>
                    </a>
                    <a href="https://maps.google.com/?q=Padang+Sumatera+Barat" target="_blank"
                        ...
                        <div class="w-12 h-12 rounded-full bg-[#7A1F2B]/10 flex items-center justify-center text-[#7A1F2B]">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-500 mt-0.5">Padang, Sumatera Barat</div>
                        </div>
                    </a>
                </div>
            </div>
