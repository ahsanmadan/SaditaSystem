                        ...
                        @else
                            <div class="mt-5 space-y-4">
                                ...
                                <a href="{{ route('invoice.print', ['order_id' => $order->kode_pesanan]) }}" target="_blank"
                                    class="flex w-full items-center justify-center gap-3 rounded-2xl border border-[#7A1F2B]/20 bg-[#FFF9F5] mt-3 px-6 py-4 text-sm font-bold tracking-wide text-[#7A1F2B] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#FAF5F0] hover:shadow-md">
                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
